package com.bonofacil.platform.iam.infrastructure.authorization.sfs.pipeline;

import com.bonofacil.platform.iam.infrastructure.authorization.sfs.model.UsernamePasswordAuthenticationTokenBuilder;
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if (token != null && tokenService.validateToken(token)) {
                ...
                //throw new UnauthorizedException("Token is not valid or not present in the request");
